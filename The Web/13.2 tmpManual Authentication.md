...
<!-- 
how to keep a session? session cookie!
use secure HttpOnly, e.g. Google 1 year
implement other checks, e.g. user agent, IP address
beware: don't use other storage
beware: already insecure against extraction from outside browser, or browser extensions
 -->
...
<!-- todo: see self-contained token in 13.3 -->
...
<!-- todo: already write this here as microservice? NO, should go directly to OAuth, standardized access delegation! Here monolith -->
