...
- used to organise data, bundle related code, expose only necessary interfaces, keep implementation details private, principle of least exposure, avoids name collisions and allows for future refactoring
- until now used closure and IIFE to create modules from objects and hide state in closure
...
- ES(6) modules standardise modules in JavaScript, one module per file, won't cover third-party implementations like CommonJS Modules, they work differently because didn't think about network and browser
