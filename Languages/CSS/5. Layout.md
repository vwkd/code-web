...
- relative to position of establishing box in parent formatting context
- can visually think of as region of content area of the establishing box
- each box is laid out according to parent formatting context
- beware: a formatting context is only applied to direct children, each child establishes its own formatting context for its children, etc. ❗️
