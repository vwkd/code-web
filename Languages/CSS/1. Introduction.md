...
| - | - | - |
| `:link` | links _not yet visited_, i.e. not in user agent history | see [HTML/Introduction](../HTML/1.%20Introduction.md#Important_elements) for defintion of hyperlink |
| `:visited` | links _already visited_, i.e. in user agent history | see [HTML/Introduction](../HTML/1.%20Introduction.md#Important_elements) for defintion of hyperlink |
...
- beware: for privacy a user agent may lie about pseudo-class or limit properties that can be set, e.g. in `:visited`
