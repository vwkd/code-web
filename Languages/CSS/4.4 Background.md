...
- drawn below border
- beware: solid border style overlays background, needs to make opaque, dashed, etc. to see background
- beware: think of total box as border box, margin is not part of box, i.e. margin has no "transparent background", see Margin ❗️
