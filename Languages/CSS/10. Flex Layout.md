...
<!-- beware: should have been named `justify-items` since justifies items instead of line ❗️ -->
...
- beware: identical `align-self` applies instead to individual flex item, overrides `align-items` of parent ❗️
