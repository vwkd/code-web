...
- beware: logical shorthands for `inset`, `margin`, `padding`, `border-width`, `border-style`, `border-color` are still under discussion, see [#1282](https://github.com/w3c/csswg-drafts/issues/1282)
