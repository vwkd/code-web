...
- discriminated union: union of object types which contain a common property whose value is a literal type, allows to switch cases based on the literal type
- can use discriminated union to replace simple classical class hierarchies 
