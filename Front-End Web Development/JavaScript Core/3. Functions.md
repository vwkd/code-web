...
- no separate `this`, takes `this` from enclosing scope _at time of definition_, i.e. can use as function inside a method without needing to specify `this`, but not as method itself because `this´ would be global object ❗️
...
function Person(name) {
  ...
  this.sayHi2 = () => {console.log("Hi, my name is " + this.name);};
}
...
// outside constructor 'this' context is global object
function Person(name) {
  this.name = name;
}

Person.prototype.sayHi = function() {console.log("Hi, my name is " + this.name);};
Person.prototype.sayHi2 = () => {console.log("Hi, my name is " + this.name);};
